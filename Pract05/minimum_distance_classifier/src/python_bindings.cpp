...
PYBIND11_MODULE(mdc_core, m) {
    ...
    py::class_<mdc::MinimumDistanceClassifier>(m, "MinimumDistanceClassifier")
        ...
        .def("fit", &mdc::MinimumDistanceClassifier::fit, py::arg("X"), py::arg("y"),
             "Train the classifier\n\n"
             "Parameters:\n"
             "  X: list of lists, shape (n_samples, n_features)\n"
             "  y: list of ints, shape (n_samples,)")

        .def("predict", &mdc::MinimumDistanceClassifier::predict, py::arg("X"),
        ...
        .def("is_using_cuda", &mdc::MinimumDistanceClassifier::is_using_cuda,
             "Check if CUDA is being used")

        .def("is_fitted", &mdc::MinimumDistanceClassifier::is_fitted,
             "Check if model has been trained")

        .def("get_n_classes", &mdc::MinimumDistanceClassifier::get_n_classes,
             "Get number of classes")

        .def("get_n_features", &mdc::MinimumDistanceClassifier::get_n_features,
