...
void simulated_annealing(CoolingSchedule cooling_type, double s_temp, double alpha, int ations) {
    ...
    std::cout << "SA with initial state: (" << current_state.x << ", " << current_state.y
              << ") and energy: " << current_state.energy << std::endl;
    ...
    std::cout << "Optimal state found at: (" << best_state.x << ", " << best_state.y << ")"
              << std::endl;
